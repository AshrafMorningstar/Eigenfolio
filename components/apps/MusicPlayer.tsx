            ...
            <div className="space-y-6 z-10">
                ...
                <div className="flex items-center justify-center gap-8">
                    ...
                    <button 
                        ...
                        className="w-16 h-16 rounded-full flex items-center justify-center text-white shadow-lg hover:shadow-quantum-glow/50 hover:scale-110 transition-all active:scale-95 border border-white/10"
